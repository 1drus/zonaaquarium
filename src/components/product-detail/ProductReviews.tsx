  ...
  if (reviews.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-muted-foreground">Jadilah yang pertama memberikan ulasan untuk produk ini</p>
      </div>
    );
  }
        ...
        <CardContent className="pt-6">
          <div className="grid md:grid-cols-2 gap-6">
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground mt-2">Dari {stats.total} ulasan</p>
            </div>
            ...
            <CardContent className="pt-6">
              <div className="flex gap-4">
                <Avatar>
                  ...
                  <AvatarFallback>{(review.reviewer_name || "Pengguna").charAt(0).toUpperCase()}</AvatarFallback>
                </Avatar>
                <div className="flex-1 space-y-2">
                  <div className="flex items-start justify-between">
                    <div>
                      <p className="font-semibold">{review.reviewer_name || "Pengguna"}</p>
                  ...
                  {review.is_verified_purchase && (
                    <span className="text-xs text-green-600 font-medium">✓ Pembelian Terverifikasi</span>
                  )}
